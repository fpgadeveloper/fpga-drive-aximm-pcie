...
#set_property PACKAGE_PIN Y1 [get_ports {pci_exp_0_rxn[0]}]
#set_property PACKAGE_PIN Y2 [get_ports {pci_exp_0_rxp[0]}]
#set_property PACKAGE_PIN AA3 [get_ports {pci_exp_0_txn[0]}]
#set_property PACKAGE_PIN AA4 [get_ports {pci_exp_0_txp[0]}]
