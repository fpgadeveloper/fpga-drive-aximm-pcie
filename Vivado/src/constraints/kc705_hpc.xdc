#----------------------------------------------------------------------------------------
# Constraints for Opsero FPGA Drive FMC Gen4 ref design for KC705-HPC using 1x SSD
#----------------------------------------------------------------------------------------

# SSD1 PCI Express reset (perst_0)
set_property PACKAGE_PIN C25 [get_ports {perst_0[0]}]; # LA00_CC_P
set_property IOSTANDARD LVCMOS25 [get_ports {perst_0[0]}]

# SSD1 PE Detect (pedet_0, not connected in the design)
# set_property PACKAGE_PIN B25 [get_ports {pedet_0[0]}]; # LA00_CC_N
# set_property IOSTANDARD LVCMOS25 [get_ports {pedet_0[0]}]

# Disable signal for 3.3V power supply for SSD2 (disable_ssd2_pwr)
set_property PACKAGE_PIN E28 [get_ports disable_ssd2_pwr]; # LA07_P
...
# SSD1 ref clock
set_property PACKAGE_PIN C8 [get_ports {ref_clk_0_clk_p[0]}]; # GBTCLK0_M2C_P
set_property PACKAGE_PIN C7 [get_ports {ref_clk_0_clk_n[0]}]; # GBTCLK0_M2C_N
