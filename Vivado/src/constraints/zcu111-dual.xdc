# These constraints apply to the ZCU111 FMC+ with FPGA Drive FMC using 2x SSDs
# ----------------------------------------------------------------------------
...
set_property PACKAGE_PIN AG12 [get_ports {perst_1[0]}]
...
# SSD2 ref clock connects to MGT bank 130, CLK0 input
set_property PACKAGE_PIN U33 [get_ports {ref_clk_1_clk_p[0]}]
set_property PACKAGE_PIN U34 [get_ports {ref_clk_1_clk_n[0]}]
...
# ZCU111 FMC+ transceivers for SSD2 are best aligned with PCIE_X0Y1
set_property LOC PCIE40E4_X0Y1 [get_cells *_i/xdma_1/inst/pcie4_ip_i/inst/pcie_4_0_pipe_inst/pcie_4_0_e4_inst]
