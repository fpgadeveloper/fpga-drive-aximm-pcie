...
set_property LOC GTYE4_CHANNEL_X0Y28 [get_cells -hier -filter {NAME =~ *_i/axi_pcie_1/*/gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST}]
set_property LOC GTYE4_CHANNEL_X0Y29 [get_cells -hier -filter {NAME =~ *_i/axi_pcie_1/*/gtye4_channel_gen.gen_gtye4_channel_inst[1].GTYE4_CHANNEL_PRIM_INST}]
set_property LOC GTYE4_CHANNEL_X0Y30 [get_cells -hier -filter {NAME =~ *_i/axi_pcie_1/*/gtye4_channel_gen.gen_gtye4_channel_inst[2].GTYE4_CHANNEL_PRIM_INST}]
set_property LOC GTYE4_CHANNEL_X0Y31 [get_cells -hier -filter {NAME =~ *_i/axi_pcie_1/*/gtye4_channel_gen.gen_gtye4_channel_inst[3].GTYE4_CHANNEL_PRIM_INST}]
