...
set_property PACKAGE_PIN AD40 [get_ports perst_0[0]]
...
set_property PACKAGE_PIN K8 [get_ports {ref_clk_0_clk_p[0]}]
set_property PACKAGE_PIN K7 [get_ports {ref_clk_0_clk_n[0]}]
