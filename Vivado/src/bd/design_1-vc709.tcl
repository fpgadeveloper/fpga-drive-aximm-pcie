...
set axi_pcie_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_pcie3:2.0 axi_pcie_1 ]
...
connect_bd_net -net pcie_reset_n [get_bd_ports perst_n] [get_bd_pins axi_pcie_1/sys_rst_n]
