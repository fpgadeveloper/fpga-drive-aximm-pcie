...
connect_bd_net [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
...
connect_bd_net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]
connect_bd_net [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out]

# Connect interrupt
connect_bd_net [get_bd_pins axi_pcie_0/interrupt_out] [get_bd_pins processing_system7_0/IRQ_F2P]
