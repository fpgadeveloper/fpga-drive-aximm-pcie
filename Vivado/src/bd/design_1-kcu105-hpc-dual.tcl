...
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_pcie3 axi_pcie3_1
...
# BAR0 set to 512GB
create_bd_addr_seg -range 0x20000000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_pcie3_0/S_AXI/BAR0] SEG_axi_pcie3_0_BAR0
create_bd_addr_seg -range 0x20000000 -offset 0x60000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_pcie3_1/S_AXI/BAR0] SEG_axi_pcie3_1_BAR0
...
create_bd_addr_seg -range 0x10000000 -offset 0x30000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_pcie3_1/S_AXI_CTL/CTL0] SEG_axi_pcie3_1_CTL0
# Other peripherals
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/axi_pcie3_0/axi_aclk (250 MHz)} Clk_slave {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/axi_pcie3_0/M_AXI} Slave {/ddr4_0/C0_DDR4_S_AXI} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_0/M_AXI]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_0/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/addn_ui_clkout1 (100 MHz)} Master {/microblaze_0 (Periph)} Slave {/axi_pcie3_0/S_AXI} intc_ip {/microblaze_0_axi_periph} master_apm {0}}  [get_bd_intf_pins axi_pcie3_0/S_AXI]

apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_1/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/addn_ui_clkout1 (100 MHz)} Master {/microblaze_0 (Periph)} Slave {/axi_pcie3_1/S_AXI_CTL} intc_ip {/microblaze_0_axi_periph} master_apm {0}}  [get_bd_intf_pins axi_pcie3_1/S_AXI_CTL]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/axi_pcie3_1/axi_aclk (250 MHz)} Clk_slave {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/axi_pcie3_1/M_AXI} Slave {/ddr4_0/C0_DDR4_S_AXI} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_1/M_AXI]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_1/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/addn_ui_clkout1 (100 MHz)} Master {/microblaze_0 (Periph)} Slave {/axi_pcie3_1/S_AXI} intc_ip {/microblaze_0_axi_periph} master_apm {0}}  [get_bd_intf_pins axi_pcie3_1/S_AXI]

# Using the cached interface for S_AXI and CTL
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_0/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/microblaze_0 (Cached)} Slave {/axi_pcie3_0/S_AXI_CTL} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_0/S_AXI_CTL]
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_0/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/microblaze_0 (Cached)} Slave {/axi_pcie3_0/S_AXI} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_0/S_AXI]
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_1/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/microblaze_0 (Cached)} Slave {/axi_pcie3_1/S_AXI_CTL} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_1/S_AXI_CTL]
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/axi_pcie3_1/axi_aclk (250 MHz)} Clk_xbar {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Master {/microblaze_0 (Cached)} Slave {/axi_pcie3_1/S_AXI} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_pcie3_1/S_AXI]
...
set_property -dict [list CONFIG.AXIBAR_NUM {1} \
CONFIG.BASEADDR {0x30000000} \
CONFIG.HIGHADDR {0x3FFFFFFF} \
CONFIG.device_port_type {Root_Port_of_PCI_Express_Root_Complex} \
CONFIG.mode_selection {Advanced} \
...
CONFIG.pf0_class_code {060400} \
CONFIG.pf0_msix_cap_table_bir {BAR_1:0} \
CONFIG.pf0_msix_cap_pba_bir {BAR_1:0}] [get_bd_cells axi_pcie3_1]
...
connect_bd_intf_net [get_bd_intf_pins axi_pcie3_0/pcie_7x_mgt] [get_bd_intf_ports pci_exp_0]
...
connect_bd_intf_net [get_bd_intf_pins axi_pcie3_1/pcie_7x_mgt] [get_bd_intf_ports pci_exp_1]

# Add constant to tie off intx_msi_Request signals
...
connect_bd_net [get_bd_pins xlconstant_0/dout] [get_bd_pins axi_pcie3_1/intx_msi_Request]
...
set_property -dict [list CONFIG.C_BUF_TYPE {IBUFDSGTE}] $ref_clk_0_buf
...
connect_bd_net [get_bd_pins ref_clk_0_buf/IBUF_DS_ODIV2] [get_bd_pins axi_pcie3_0/refclk]
connect_bd_net [get_bd_pins ref_clk_0_buf/IBUF_OUT] [get_bd_pins axi_pcie3_0/sys_clk_gt]
...
set_property -dict [list CONFIG.C_BUF_TYPE {IBUFDSGTE}] $ref_clk_1_buf
# refclk and sys_clk_gt connected as per page 10 of AXI Bridge PCIe Gen3 Product guide
# http://www.xilinx.com/support/documentation/ip_documentation/axi_pcie3/v2_0/pg194-axi-bridge-pcie-gen3.pdf
connect_bd_net [get_bd_pins ref_clk_1_buf/IBUF_DS_ODIV2] [get_bd_pins axi_pcie3_1/refclk]
connect_bd_net [get_bd_pins ref_clk_1_buf/IBUF_OUT] [get_bd_pins axi_pcie3_1/sys_clk_gt]
...
connect_bd_net [get_bd_pins axi_pcie3_1/interrupt_out] [get_bd_pins microblaze_0_xlconcat/In3]
connect_bd_net [get_bd_pins axi_quad_spi_0/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In4]
...
connect_bd_net [get_bd_pins axi_pcie3_0/axi_aclk] [get_bd_pins rst_pcie_0_axi_aclk/slowest_sync_clk]
connect_bd_net [get_bd_pins axi_pcie3_0/axi_ctl_aresetn] [get_bd_pins rst_pcie_0_axi_aclk/ext_reset_in]
disconnect_bd_net /axi_pcie3_0_axi_aresetn [get_bd_pins microblaze_0_axi_periph/M04_ARESETN]
connect_bd_net [get_bd_pins rst_pcie_0_axi_aclk/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN]

# Add proc system reset for axi_pcie3_1/axi_ctl_aresetn
create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset rst_pcie_1_axi_aclk
connect_bd_net [get_bd_pins axi_pcie3_1/axi_aclk] [get_bd_pins rst_pcie_1_axi_aclk/slowest_sync_clk]
connect_bd_net [get_bd_pins axi_pcie3_1/axi_ctl_aresetn] [get_bd_pins rst_pcie_1_axi_aclk/ext_reset_in]
disconnect_bd_net /axi_pcie3_1_axi_aresetn [get_bd_pins microblaze_0_axi_periph/M06_ARESETN]
connect_bd_net [get_bd_pins rst_pcie_1_axi_aclk/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN]
