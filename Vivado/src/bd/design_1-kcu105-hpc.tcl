...
# Inverter for the external perst output signal
...
connect_bd_net -net axi_pcie_1_axi_aresetn [get_bd_pins axi_pcie_1/axi_aresetn] [get_bd_pins util_vector_logic_1/Op1]
# Reset for PCIe
connect_bd_net -net util_vector_logic_1_Res [get_bd_pins util_vector_logic_1/Res] [get_bd_ports perst]
