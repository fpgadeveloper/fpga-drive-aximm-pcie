...
CONFIG.XLNX_REF_BOARD {VC707}] [get_bd_cells axi_pcie_0]
...
# Configure Microblaze for 3 interrupts and connect them
...
connect_bd_net $perst_n [get_bd_pins rst_axi_pcie_0_62M/ext_reset_in]
...
connect_bd_net $perst_n [get_bd_pins rst_axi_pcie_ctl/ext_reset_in]
...
connect_bd_net $perst_n [get_bd_pins axi_pcie_0/axi_aresetn]
...
set_property -dict [list CONFIG.M01_HAS_REGSLICE {4}] [get_bd_cells axi_mem_intercon]
