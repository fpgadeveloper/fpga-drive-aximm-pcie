#
# build.tcl: Tcl script for re-creating project 'kc705_lpc_aximm_pcie'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/kc705_lpc_aximm_pcie"]"

# Create project
create_project kc705_lpc_aximm_pcie ./kc705_lpc_aximm_pcie

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects kc705_lpc_aximm_pcie]
...
puts "INFO: Project created:kc705_lpc_aximm_pcie"

# Create block design
source $origin_dir/src/bd/design_1-kc705-lpc.tcl
