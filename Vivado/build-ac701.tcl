#
# build.tcl: Tcl script for re-creating project 'ac701_aximm_pcie'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/ac701_aximm_pcie"]"

# Create project
create_project ac701_aximm_pcie ./ac701_aximm_pcie

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects ac701_aximm_pcie]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2015} -strategy "Performance_Explore" -constrset constrs_1 -parent_run synth_1
} else {
...
puts "INFO: Project created:ac701_aximm_pcie"
