...
set design_name zcu111_pcie_dual
...
# Create project
create_project $design_name $origin_dir/$design_name -part xczu28dr-ffvg1517-2-e
...
set file "[file normalize "$origin_dir/src/constraints/zcu111-dual.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/zcu111-dual.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/zcu111-dual.xdc"]" $obj
