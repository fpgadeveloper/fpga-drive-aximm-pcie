#
# build.tcl: Tcl script for re-creating project 'kcu105_hpc_pcie_dual'
#
#*****************************************************************************************
...
set design_name kcu105_hpc_pcie_dual
...
set file "[file normalize "$origin_dir/src/constraints/kcu105-hpc-dual.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/kcu105-hpc-dual.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/kcu105-hpc-dual.xdc"]" $obj
...
# Create block design
source $origin_dir/src/bd/design_1-kcu105-hpc-dual.tcl
