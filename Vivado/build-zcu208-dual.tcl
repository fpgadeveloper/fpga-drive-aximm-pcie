#
# build.tcl: Tcl script for re-creating project 'zcu111_pcie_dual'
#
#*****************************************************************************************
...
set design_name zcu208_pcie_dual
...
# Create project
create_project $design_name $origin_dir/$design_name -part xczu48dr-fsvg1517-2-e
...
set file "[file normalize "$origin_dir/src/constraints/zcu208-dual.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/zcu208-dual.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/zcu208-dual.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu48dr-fsvg1517-2-e -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu48dr-fsvg1517-2-e -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
