#
# build.tcl: Tcl script for re-creating project 'pz_7z030_lpc_aximm_pcie'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/pz_7z030_lpc_aximm_pcie"]"

# Create project
create_project pz_7z030_lpc_aximm_pcie ./pz_7z030_lpc_aximm_pcie

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects pz_7z030_lpc_aximm_pcie]
...
puts "INFO: Project created:pz_7z030_lpc_aximm_pcie"

# Create block design
source $origin_dir/src/bd/design_1-pz-7z030.tcl
