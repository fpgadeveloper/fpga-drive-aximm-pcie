#
# build.tcl: Tcl script for re-creating project 'vcu118_pcie_dual'
#
#*****************************************************************************************
...
set design_name vcu118_pcie_dual
...
set file "[file normalize "$origin_dir/src/constraints/vcu118-fmcp-dual.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/vcu118-fmcp-dual.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/vcu118-fmcp-dual.xdc"]" $obj
