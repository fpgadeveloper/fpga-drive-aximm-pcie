#
# build.tcl: Tcl script for re-creating project 'kc705_aximm_pcie'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/kc705_aximm_pcie"]"

# Create project
create_project kc705_aximm_pcie ./kc705_aximm_pcie

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects kc705_aximm_pcie]
...
set file "[file normalize "$origin_dir/src/constraints/kc705.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/kc705.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/kc705.xdc"]" $obj
