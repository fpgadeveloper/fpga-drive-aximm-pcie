...
# bsp/vck190 is shared by vck190_fmcp1/fmcp2; the PL difference between them is
# carried by each target's own SDT, so a single shared system-user.dtsi (SoC
# fixups only) is correct.
#
